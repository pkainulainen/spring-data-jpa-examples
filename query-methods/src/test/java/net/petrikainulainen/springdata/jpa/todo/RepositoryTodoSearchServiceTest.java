    ...
    public class FindBySearchTerm {
        ...
        public void createPageRequest() {
            ...
            Page<Todo> emptyPage = new PageBuilder<Todo>()
                    ...
                    .totalElements(0)
                    .build();
            given(repository.findBySearchTerm(eq(SEARCH_TERM), eq(pageRequest))).willReturn(emptyPage);
        }
        ...
        public class WhenOneTodoEntryIsFound {
            ...
            public void returnOneTodoEntry() {
                ...
                given(repository.findBySearchTerm(eq(SEARCH_TERM), eq(pageRequest))).willReturn(resultPage);
            }
